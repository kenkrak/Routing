...
class MapNode implements Comparable
{
	...
	MapNode(GeographicPoint loc)
	{
		...
		actualDistance = 0.0;
		distFromStart = Double.POSITIVE_INFINITY;
	}
    ...
    public static Comparator<MapNode> distanceComparator = new Comparator<MapNode>(){

        @Override
        public int compare(MapNode node1, MapNode node2) {
            return (int) (node2.getDistance() - node1.getDistance());
        }
    };
